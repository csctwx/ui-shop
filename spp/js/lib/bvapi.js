...
$BV.Internal.configureLoader({
  ...
  "jquery.core": "http://ajax.googleapis.com/ajax/libs/jquery/1.6.3/jquery.min.js"
}, {
  "global": {
...
$BV.configure({
  "global": {
    ...
    "urlPathPrefix": "",
    "allowedDomains": [".boost.ugc.bazaarvoice.com", ".boostmobile.com", ".c6.prr-display.prod.us-east-1.nexus.bazaarvoice.com"],
    "siwCrossDomainUrl": "http://boost.si.bazaarvoice.com/content/8149-en_us/socialInsightsWorkbench.htm",
  ...
  "rr": {
    ...
    "standaloneUrlBase": "http://reviews.boostmobile.com",
...
$BV.Internal.define("bvscout", [window, $BV, $BV.Internal], [], function(g, a, c) {
  if (a && a.getConfiguration) {
    var b = a.getConfiguration();
    var e = b.clientName;
    var d = b.displayCode;
    if (e && d) {
      c._bvScoutEventQueue = [];
      a.setUser = function h(i) {
        a.Internal._bvScoutEventQueue.push({
          method: "setUser",
          shopperId: i
        })
      };
      a.getUser = function f(i, j) {
        a.Internal._bvScoutEventQueue.push({
          method: "getUser",
          shopperId: i,
          callback: j
      ...
      c.require(["https://apps.nexus.bazaarvoice.com/" + e + "/" + d + "/bv.js"])
    }
  }
});
